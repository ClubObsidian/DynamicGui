...
public abstract class FakeServer {
	...
	public abstract void registerOutgoingPluginChannel(DynamicGuiPlugin2 plugin, String channel);
	public abstract void registerIncomingPluginChannel(DynamicGuiPlugin2 plugin, String channel);
