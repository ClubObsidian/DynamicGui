...
import com.clubobsidian.dynamicgui.mock.command.MockCommandManager;
import com.clubobsidian.dynamicgui.mock.entity.player.MockPlayer;
import com.clubobsidian.dynamicgui.mock.entity.player.MockPlayerWrapper;
import com.clubobsidian.dynamicgui.mock.inject.MockPluginModule;
...
import com.clubobsidian.dynamicgui.mock.plugin.MockDynamicGuiPlugin;
import com.clubobsidian.dynamicgui.mock.plugin.MockEconomy;
import com.clubobsidian.dynamicgui.mock.plugin.MockPermission;
import com.clubobsidian.dynamicgui.mock.plugin.MockPlatform;
import com.clubobsidian.dynamicgui.mock.world.MockLocation;
import com.clubobsidian.dynamicgui.mock.world.MockLocationWrapper;
import com.clubobsidian.dynamicgui.mock.world.MockWorld;
...
public class MockFactory {
    ...
    public Slot createSlot(int index,
                           String type,
                           List<String> lore,
                           List<EnchantmentWrapper> enchants,
                           boolean movable) {
        return new Slot.Builder().setIndex(index)
                .setType(type)
                .setName("test")
                .addLore(lore)
                .addEnchant(enchants)
